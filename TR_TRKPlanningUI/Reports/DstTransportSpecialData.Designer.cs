...
namespace FM.TruckPlanning.Reports.DstTransportSpecialDataTableAdapters {
    ...
    public partial class TPT_SPECIAL_DATA_TblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [TPT_SPECIAL_DATA_Tbl] ([RECORD_KEY], [TPT_CODE], [TPT_NAME], [ADDRESS1], [ADDRESS2], [ADDRESS3], [ADDRESS4], [BOOKING_NO], [JOB_NO], [BOOKING_NO_PREFIX], [JOB_NO_PREFIX], [LOG_NO], [PRICES_VISIBLE_IN_JOB], [QUANTITY_DECIMAL], [FOREIGN_CURRENCY_DECIMAL], [TOTAL_AMOUNT_DECIMAL], [UNIT_AMOUNT_DECIMAL], [QUOTATION_NO]) VALUES (@RECORD_KEY, @TPT_CODE, @TPT_NAME, @ADDRESS1, @ADDRESS2, @ADDRESS3, @ADDRESS4, @BOOKING_NO, @JOB_NO, @BOOKING_NO_PREFIX, @JOB_NO_PREFIX, @LOG_NO, @PRICES_VISIBLE_IN_JOB, @QUANTITY_DECIMAL, @FOREIGN_CURRENCY_DECIMAL, @TOTAL_AMOUNT_DECIMAL, @UNIT_AMOUNT_DECIMAL, @QUOTATION_NO);
SELECT RECORD_KEY, TPT_CODE, TPT_NAME, ADDRESS1, ADDRESS2, ADDRESS3, ADDRESS4, BOOKING_NO, JOB_NO, BOOKING_NO_PREFIX, JOB_NO_PREFIX, LOG_NO, PRICES_VISIBLE_IN_JOB, QUANTITY_DECIMAL, FOREIGN_CURRENCY_DECIMAL, TOTAL_AMOUNT_DECIMAL, UNIT_AMOUNT_DECIMAL, QUOTATION_NO FROM TPT_SPECIAL_DATA_Tbl WHERE (RECORD_KEY = @RECORD_KEY)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TPT_SPECIAL_DATA_Tbl] SET [RECORD_KEY] = @RECORD_KEY, [TPT_CODE] = @TPT_C" +
                ...
                "MAL] = @UNIT_AMOUNT_DECIMAL, [QUOTATION_NO] = @QUOTATION_NO WHERE (([RECORD_KEY]" +
                " = @Original_RECORD_KEY) AND ([TPT_CODE] = @Original_TPT_CODE) AND ([TPT_NAME] =" +
                " @Original_TPT_NAME) AND ([ADDRESS1] = @Original_ADDRESS1) AND ([ADDRESS2] = @Or" +
                "iginal_ADDRESS2) AND ([ADDRESS3] = @Original_ADDRESS3) AND ([ADDRESS4] = @Origin" +
                "al_ADDRESS4) AND ([BOOKING_NO] = @Original_BOOKING_NO) AND ([JOB_NO] = @Original" +
                "_JOB_NO) AND ([BOOKING_NO_PREFIX] = @Original_BOOKING_NO_PREFIX) AND ([JOB_NO_PR" +
                "EFIX] = @Original_JOB_NO_PREFIX) AND ([LOG_NO] = @Original_LOG_NO) AND ([PRICES_" +
                "VISIBLE_IN_JOB] = @Original_PRICES_VISIBLE_IN_JOB) AND ([QUANTITY_DECIMAL] = @Or" +
                "iginal_QUANTITY_DECIMAL) AND ([FOREIGN_CURRENCY_DECIMAL] = @Original_FOREIGN_CUR" +
                "RENCY_DECIMAL) AND ([TOTAL_AMOUNT_DECIMAL] = @Original_TOTAL_AMOUNT_DECIMAL) AND" +
                " ([UNIT_AMOUNT_DECIMAL] = @Original_UNIT_AMOUNT_DECIMAL) AND ([QUOTATION_NO] = @" +
                ...
                "AMOUNT_DECIMAL, UNIT_AMOUNT_DECIMAL, QUOTATION_NO FROM TPT_SPECIAL_DATA_Tbl WHER" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = FMGlobalSettings.TheInstance.getConnectionString();
        }
        ...
        public virtual int Update(
            ...
            if ((Original_RECORD_KEY == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_RECORD_KEY));
            }
            if ((Original_TPT_CODE == null)) {
                throw new global::System.ArgumentNullException("Original_TPT_CODE");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_TPT_CODE));
            }
            if ((Original_TPT_NAME == null)) {
                throw new global::System.ArgumentNullException("Original_TPT_NAME");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_TPT_NAME));
            }
            if ((Original_ADDRESS1 == null)) {
                throw new global::System.ArgumentNullException("Original_ADDRESS1");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(Original_BOOKING_NO));
            this.Adapter.UpdateCommand.Parameters[26].Value = ((int)(Original_JOB_NO));
            if ((Original_BOOKING_NO_PREFIX == null)) {
                throw new global::System.ArgumentNullException("Original_BOOKING_NO_PREFIX");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[27].Value = ((string)(Original_BOOKING_NO_PREFIX));
            }
            if ((Original_JOB_NO_PREFIX == null)) {
                throw new global::System.ArgumentNullException("Original_JOB_NO_PREFIX");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[28].Value = ((string)(Original_JOB_NO_PREFIX));
            }
            this.Adapter.UpdateCommand.Parameters[29].Value = ((int)(Original_LOG_NO));
            if ((Original_PRICES_VISIBLE_IN_JOB == null)) {
                throw new global::System.ArgumentNullException("Original_PRICES_VISIBLE_IN_JOB");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[30].Value = ((string)(Original_PRICES_VISIBLE_IN_JOB));
            }
            this.Adapter.UpdateCommand.Parameters[31].Value = ((int)(Original_QUANTITY_DECIMAL));
            this.Adapter.UpdateCommand.Parameters[32].Value = ((int)(Original_FOREIGN_CURRENCY_DECIMAL));
            this.Adapter.UpdateCommand.Parameters[33].Value = ((int)(Original_TOTAL_AMOUNT_DECIMAL));
            this.Adapter.UpdateCommand.Parameters[34].Value = ((int)(Original_UNIT_AMOUNT_DECIMAL));
            this.Adapter.UpdateCommand.Parameters[35].Value = ((int)(Original_QUOTATION_NO));
