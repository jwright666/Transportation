...
using System.Text;
using FM.TR_MaintenanceUI.UI;

namespace FM.TR_MaintenanceUI
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            bool createdNew;
            Mutex mutex = new Mutex(false, "TRMaintenanceUI", out createdNew);
            ...
            else
            {
                ...
                args = new string[3];
                args[0] = "ipl";
                args[1] = "PC-5\\SQLEXPRESS";// ; //"MS2012STD\\SQL2012DEV";//"TONI\\FM";//"support-srv\\innosqlmaster";//
                args[2] = "FM80_SG_Demo"; //; //"FM80_SG_USS";//  //"FM80_SG_WYN2KTRANSPORT";
                #endregion
                ///*                                                      
